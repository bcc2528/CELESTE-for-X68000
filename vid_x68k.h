...
#define SP_BASE (0xEB0000)
#define SP_HTOTAL (SP_BASE+0x80A)
#define SP_HDISP (SP_BASE+0x80C)
#define SP_VDISP (SP_BASE+0x80E)
#define SP_VHRES (SP_BASE+0x810)

short *sp_htotal = (short*)SP_HTOTAL;
short *sp_hdisp = (short*)SP_HDISP;
short *sp_vdisp = (short*)SP_VDISP;
short *sp_vhres = (short*)SP_VHRES;
